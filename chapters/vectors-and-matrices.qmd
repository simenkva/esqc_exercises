...
## Exercises: Basic vectors and matrix calculations

::: {#exr-vector-spaces-basic-operations recommended="math" level="beginner"}
### Basic vector operations

Consider the vectors

$$
x=(1,2,-1),\qquad y=(3,-1,2),\qquad z=(0,2,1)
$$
...
d. Compute the linear combination $2x+3y$.

e. Compute $x+2y-z$.

f. Find numbers $\alpha$ and $\beta$ such that $\alpha x+\beta y=(7,0,3)$.

g. Verify by direct calculation that $2(x+y)=2x+2y$. Which vector-space axiom does this illustrate?
...
::: {#exr-matrix-vector-multiplication recommended="math" level="beginner"}
### Matrix-vector products

Consider the matrices and vectors

$$
A=\begin{pmatrix}2&-1\\3&4\end{pmatrix},\qquad B=\begin{pmatrix}1&0&2\\-1&3&1\end{pmatrix},\qquad x=\begin{pmatrix}3\\2\end{pmatrix},\qquad y=\begin{pmatrix}1\\-2\\3\end{pmatrix}.
$$
...
::: {#exr-matrix-matrix-multiplication recommended="math" level="beginner"}
...
::: {#exr-vectors-and-matrices-gaussian-elimination-compute-coefficients-such-illustrate recommended="math" level="beginner"}
...
:::{#exr-vectors-and-matrices-boat-sailing-ocean-at-constant-speed recommended="math" level="intermediate"}
...
:::{#exr-vectors-and-matrices-robert-beezer-three-digit-number-has recommended="math" level="intermediate"}
...
:::{#exr-vectors-and-matrices-write-terms-column-vectors-prove-i level="intermediate"}
...
a. Suppose we write $\mathbf{b}_1 x_1 + \mathbf{b}_2 x_2 = 0$. We must show that $x_1=x_2 = 0$ is the only solution. By adding the equations, we get $3 x1 = 0$, and then by insertion into the first equation $x_2 = 0$. 

b. Since we have 2 linearly independent vectors in $\mathbb{R}^2$, these form a basis.
...
$$
B=[\mathbf{b}_1,\ldots,\mathbf{b}_o].
$$
...
$$
(A\mathbf{b}_j)_i=\sum_{k=1}^m A_{ik}B_{kj}=(AB)_{ij}.
$$

Hence the $j$th column of $AB$ is $A\mathbf{b}_j$, and therefore

$$
AB=[A\mathbf{b}_1,\ldots,A\mathbf{b}_o].
$$
...
$$
(\mathbf{a}_i^TB)_j=\sum_{k=1}^m A_{ik}B_{kj}=(AB)_{ij}.
$$

Thus the $i$th row of $AB$ is $\mathbf{a}_i^TB$, and therefore
