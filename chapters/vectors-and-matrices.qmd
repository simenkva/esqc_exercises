...
### Basic matrix-vector products {.unnumbered}
...
### Matrix-matrix products {.unnumbered}
...
### Linear independence and basis {.unnumbered}
...
### Gaussian elimination and vector decomposition {.unnumbered}
...
### Boat sailing on the ocean {.unnumbered}
...
### An exercise by Robert Beezer {.unnumbered}
...
### Compute the action of a matrix on vectors {.unnumbered}
...
### Matrix-matrix products, rows and columns {.unnumbered}
