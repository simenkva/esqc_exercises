...
::: {#exr-vectors-and-matrices-gaussian-elimination-compute-coefficients-such-illustrate .recommended topic="recommended"}
...
::: {#exr-vectors-and-matrices-person-walks-home-first-they-walk .recommended topic="recommended"}
...
::: {#exr-vectors-and-matrices-matrix-products-between-pairs-these-matrices .recommended topic="recommended"}
...
::: {#exr-vectors-and-matrices-matrix-defined-zero-otherwise-compute-action .recommended topic="recommended"}
