...
[[Solution ↓](#solution-for-exr-complex-arithmetic-compute-real-imaginary-parts-functions)]{.content-visible when-profile="tutor"}
...
[[Solution ↓](#solution-for-exr-complex-arithmetic-compute-closed-form-expression-real-imaginary)]{.content-visible when-profile="tutor"}
...
[[Solution ↓](#solution-for-exr-complex-arithmetic-compute-closed-form-expression-exhibiting-real)]{.content-visible when-profile="tutor"}
...
[[Solution ↓](#solution-for-exr-complex-arithmetic-complex-numbers-can-written-polar-form)]{.content-visible when-profile="tutor"}
...
[[Solution ↓](#solution-for-exr-complex-arithmetic-consider-polynomial-equation-find-all-roots)]{.content-visible when-profile="tutor"}

:::

### Basic calculations {.unnumbered}
...
### Solution to @exr-complex-arithmetic-compute-real-imaginary-parts-functions {#solution-for-exr-complex-arithmetic-compute-real-imaginary-parts-functions .unnumbered}
...
### Solution to @exr-complex-arithmetic-compute-closed-form-expression-real-imaginary {#solution-for-exr-complex-arithmetic-compute-closed-form-expression-real-imaginary .unnumbered}
...
### Solution to @exr-complex-arithmetic-compute-closed-form-expression-exhibiting-real {#solution-for-exr-complex-arithmetic-compute-closed-form-expression-exhibiting-real .unnumbered}
...
### Solution to @exr-complex-arithmetic-complex-numbers-can-written-polar-form {#solution-for-exr-complex-arithmetic-complex-numbers-can-written-polar-form .unnumbered}

The geometric interpretation gives $\phi = n\theta$ (modulus $2\pi$) and $R = r^n$.

### Solution to @exr-complex-arithmetic-consider-polynomial-equation-find-all-roots {#solution-for-exr-complex-arithmetic-consider-polynomial-equation-find-all-roots .unnumbered}
