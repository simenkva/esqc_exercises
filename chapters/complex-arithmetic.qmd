...
### Solution to @exr-recommended-complex-arithmetic-compute-real-imaginary-parts-functions
...
### Solution to @exr-complex-arithmetic-compute-closed-form-expression-real-imaginary
...
### Solution to @exr-complex-arithmetic-compute-closed-form-expression-exhibiting-real
...
### Solution to @exr-recommended-complex-arithmetic-complex-numbers-can-written-polar-form

The geometric interpretation gives $\phi = n\theta$ (modulus $2\pi$) and $R = r^n$.

### Solution to @exr-complex-arithmetic-consider-polynomial-equation-find-all-roots
...
### Solution to @exr-recommended-complex-arithmetic-illustrate-addition-coordinate-system-parallelogram-rule

*The source does not supply a solution.*

### Solution to @exr-complex-arithmetic-recall-our-earlier-exercise-where-was

*The source does not supply a solution.*

### Solution to @exr-complex-arithmetic-another-product-indeed-cross-product-matrix

*The source does not supply a solution.*

### Solution to @exr-complex-arithmetic-function-counterclockwise-rotation-find-function-performs
