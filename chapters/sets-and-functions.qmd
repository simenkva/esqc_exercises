...
::: {#exr-sets-and-functions-write-days-week-set .recommended topic="beginner"}

Write the days of the week as a set

:::

::: {#exr-sets-and-functions-write-five-first-natural-numbers-set .recommended topic="recommended"}
...
::: {#exr-sets-and-functions-draw-picture-representing-whole-sheet-overlapping .recommended topic="recommended"}
...
::: {#exr-sets-potential-energy-curve .recommended topic="beginner"}
...
::: {#exr-molecule-sets .recommended topic="recommended"}
...
### Solution to @exr-sets-and-functions-write-days-week-set {.unnumbered}

$$U = \{ \text{Mandag, Tirsdag, Onsdag, Torsdag, Fredag, Lørdag, Søndag} \}$$

### Solution to @exr-sets-and-functions-write-five-first-natural-numbers-set {.unnumbered}
