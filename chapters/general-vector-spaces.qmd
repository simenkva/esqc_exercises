...
::: {#exr-general-vector-spaces-recipes recommended="math" level="beginner"}
...
::: {#exr-general-vector-spaces-meaningful-recipes recommended="math" level="intermediate"}
### Cooking with vectors 2

In @exr-general-vector-spaces-recipes, we represented recipes using a fixed list of possible ingredients. We can make this construction more general.
